...
import primitives, { StatusEnum } from '../../../models/primitives'
...
const TableSessionModalCheckWorker: FC<TableProps> = props => {
    ...
    const checkModal = (row: Row) => {
        return show && String(getTableRowId(row, 'id')) === currSession
    }
...
export default TableSessionModalCheckWorker
