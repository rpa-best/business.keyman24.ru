...
const Temp: FC<TableProps> = props => {
    ...
    const isLoading =
        useAppSelector(state => state.elementNestedSession.isLoading) === 'list'
...
const TableSessionElementHistory: FC<TableProps> = props => {
    const loaderData: any = useLoaderData()
    const { sessionType } = props

    const { extraId: sessionId, orgId, areaId, workerId } = loaderData
    return (
        <Temp
            sessionId={sessionId}
            orgId={orgId}
...
export default TableSessionElementHistory
