    ...
    return (
        ...
        <>
            ...
            >
                ...
                />
                <WorkerInfo org={dataFromSocket.org} worker={dataFromSocket.worker} />
            </div>
            <div
                className='d-flex h-100 flex-column'
                style={{ paddingBottom: '50px' }}
            >
                <TableSessionElement sessionType='key' refetch={refetch} />
            </div>
        </>
    )
}

const TableSessionElementKey: FC<TableProps> = props => {
...
export default TableSessionElementKey
